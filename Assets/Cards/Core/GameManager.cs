...
namespace Cards.Core
{
    public class GameManager : MonoBehaviour
    {
        ...
        public IReadOnlyList<CardInstance> EntitiesOnBoard => playerBoardZone != null ? playerBoardZone.Cards : new List<CardInstance>();
        ...
        private Cards.Rules.Handlers.CardPlayHandler cardPlayHandler;
        ...
        void Awake()
        {
            ...
            // 注册独立的事件处理器
            cardPlayHandler = new Cards.Rules.Handlers.CardPlayHandler(Context, StateMachine);
            cardDeathHandler = new Cards.Rules.Handlers.CardDeathHandler(Context);
        }

        private void OnDestroy()
        {
            cardPlayHandler?.Dispose();
        ...
        public void InitializeDeck()
        {
            ...
            // 1. 根据配置初始化卡牌实体并放在抽牌堆
            List<CardInstance> initialCards = new List<CardInstance>();
            ...
            foreach (CardData data in initialDeckConfig.cards)
            {
                ...
                CardEntityView cardView = newCardObj.GetComponent<CardEntityView>();
